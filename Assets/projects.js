const projects = [
  {
    ...
    description:
      "AI-powered talent assessment platform that automates resume screening, secure AI interviews, proctoring and candidate evaluation.",

    tech: ["OpenAI", "React", "Next.js", "FastAPI"],
  },

  {
    ...
    description:
      "AI-powered WhatsApp and RCS campaign automation platform for businesses and marketing teams.",

    tech: ["OpenAI", "WhatsApp", "RCS", "FastAPI"],
  },
  {
    slug: "talk",
    ...
    description:
      "Conversational AI voice agents for customer support, appointment booking, lead qualification and automated business calls.",

    tech: ["OpenAI", "Twilio", "React", "Next.js"],
  },
  {
    slug: "prd-generator",
    ...
    href: "/projects/prd-generator",
    featured: true,
  },
  {
    slug: "sql-pricing",
    title: "Pricing Strategy Analysis",
    subtitle: "SQL Data Analytics Project",
    cover: "/Projects/sql-pricing/cover.png",
    description:
  ...
  },
  {
    slug: "xofc",
    title: "XOFC",
    subtitle: "Interactive Football Platform",
    cover: "/Projects/xofc/cover.png",
    description:
